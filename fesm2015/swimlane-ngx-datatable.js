...
let DataTableBodyRowComponent = class DataTableBodyRowComponent {
    ...
    get cssClass() {
        ...
        const idx = +(/^((\d+)-)?(\d+)$/.exec(this.rowIndex) || [])[3];
        if (idx % 2 !== 0) {
